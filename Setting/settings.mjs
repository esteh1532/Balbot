...
export default {
  name: "Ballbot | EsTeh Plastik", //nama sih
  dev: ["6287765570421"],
  developer: JSON.parse(fs.readFileSync("./Setting/owner.json")) ?? ["6287765570421"], // Cek di owner.json
  moderator: JSON.parse(fs.readFileSync("./Setting/mod.json")) ?? [], // Cek di mods.json
  prems: JSON.parse(fs.readFileSync("./Setting/prems.json")) ?? ["6287765570421"], // cek di prems.json
  ...
  emailgh: "ppss365slk@gmail.com", // Setting to your email github
